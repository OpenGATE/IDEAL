...
def get_beamline_model_from_config(beamline_data):
    ...
    if beamline_data.from_LUT:
        ...
        # look up tables optics
        beamline.sigma_x_lut = beamline_data.sigma_x_lut
        beamline.theta_x_lut = beamline_data.theta_x_lut
        beamline.epsilon_x_lut = beamline_data.epsilon_x_lut
        beamline.sigma_y_lut = beamline_data.sigma_y_lut
        beamline.theta_y_lut = beamline_data.theta_y_lut
        beamline.epsilon_y_lut = beamline_data.epsilon_y_lut
        beamline.MU_to_N_lut = beamline_data.MU_to_N_lut
    else:
