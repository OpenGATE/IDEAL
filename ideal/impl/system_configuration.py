...
def get_simulation_install(syscfg,sysprsr,logger):
    ...
    syscfg['SPR reference energy [MeVn]'] = simulation.getfloat("SPR reference energy [MeVn]")
    syscfg['SPR transition energy [MeVn]'] = simulation.getfloat("SPR transition energy [MeVn]")
    ...
    syscfg['write dicom let']=simulation.getboolean('write dicom let',False)
    syscfg['write dicom alpha mix']=simulation.getboolean('write dicom alpha mix',False)
